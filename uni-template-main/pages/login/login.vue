	...
	<view class="content">
		...
		<view class="list">
			<view class="list-call">
				<u-icon name="email" color="#EE2626" size="40"></u-icon>
				<input class="sl-input" v-model="login.username" type="text" maxlength="20" placeholder="输入用户名"/>
			</view>
			<view class="list-call">
				<u-icon name="lock" color="#EE2626" size="40"></u-icon>
				<input class="sl-input" v-model="login.password" type="text" maxlength="32" placeholder="输入密码" password="true"/>
			</view>
...
<script>
	export default {
		data() {
			return {
				login: {
					username: 'qianbinbin1122',
					password: 'asd19920909'
				}
